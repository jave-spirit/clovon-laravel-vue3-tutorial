                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input  v-model="form.start_time" type="date" class="form-control flatpickr" :class="{'is-invalid':errors.start_time}" id="date">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input  v-model="form.end_time" type="time" class="form-control flatpickr" :class="{'is-invalid':errors.end_time}" id="time">
